				...
				<div class="product corp wrapper no-offset">
					<div>
						...
						<div class="text slience">
							...
							<span class="reserve-button"><a href="<?php echo site_url('workshop')?>">了解更多</a></span>
						</div>
						<div class="clear"></div>
					</div>
				</div>
			...
			<div class="events-wrapper">
				<div class="row">
					...
					<div class="cell pic">
						...
						<div class="dimmer">
							<img src="<?php echo get_template_directory_uri()?>/images/index-event-coffee-grey.jpg" />
						</div>
					</div>
					<div class="cell pic">
						<img src="<?php echo get_template_directory_uri()?>/images/index-event-dinner.jpg" />
						<div class="dimmer">
				...
				<div class="row">
					<div class="cell pic">
						<img src="<?php echo get_template_directory_uri()?>/images/index-event-party.jpg" />
						<div class="dimmer">
		...
		<div class="center-wrapper">
			...
			<div class="missions">
				<div class="mission">
					...
					<p>消除社会对残障和弱势群体的偏见与歧视，<br/>促进社会的包容和平等</p>
				</div>
				<div class="mission">
					<img src="<?php echo get_template_directory_uri()?>/images/index-mission-2.png" />
					<p>提升公众对自我、他人和团队的认知，<br/>增强人与人的沟通和互信</p>
			...
			<div class="brand-logos">
				...
				<div class="copyright" style="width:700px;margin:auto;margin-top:30px">
					...
					<div style="float:left;text-align:left;padding-top:20px">
						<p >Copyright黑暗中对话（中国）版权所有 &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.beian.miit.gov.cn/">沪ICP备12015459</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo site_url('contact')?>">联系我们</a></p>
						<p>Dialogue in the Dark、Dialogue in Silence、Dialogue with time是DSE的注册商标<br/>黑暗中对话、无声中对话、时间对话概念及相关商标版权属于德国对话社会企业。</p>
					</div>
				</div>
			</div>
		</div>
...
<!-- Slide Page Arrow -->
<div id="arrow-down">
	<img src="<?php echo get_template_directory_uri()?>/images/arrow-down.png" width="45" />
</div>
<script type="text/javascript">
jQuery('#sidebar .tool-news').show();

var topicAnimation = {
	onepageSupport: (!jQuery.browser.msie || jQuery.browser.version >= 10) ? true : false,
	currentIndex: 0,
